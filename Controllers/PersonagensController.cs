...
{   [Authorize]
    ...
    public class PersonagensController : ControllerBase
    {
        ...
        public PersonagensController(DataContext context, IConfiguration configuration, IHttpContextAccessor httpContextAccessor) //Construtor da controller já mapeada
        {
            _context = context;
        ...
        {
            return inte.Parse(_httpContextAccessor.HttpContex.User.FindFirstValue(ClaimTypes.NameIdentifier));
        }
        ...
        public async Task<IActionResult> Add(Personagem novoPersonagem)
        {
            try
            {
                ...
                novoPersonagem.TB_USUARIOS = _context.TB_USUARIOS.FirstOrDefault(uBusca => uBusca.Id == ObterUsuarioId());
